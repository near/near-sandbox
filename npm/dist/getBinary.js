...
function AWSUrl() {
    ...
    return `https://s3-us-west-1.amazonaws.com/build.nearprotocol.com/nearcore/${platform}-${arch}/master/712743ecbd76332ebdc254a89fbaf9c2adff1164/near-sandbox.tar.gz`;
}
